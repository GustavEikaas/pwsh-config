...
$Files = @(
  ...
  [PSCustomObject]@{ FileName = "$PSScriptRoot\bat.ps1"; DisplayName = "bat" },
  ...
  [PSCustomObject]@{ FileName = "$PSScriptRoot\dotnet.ps1"; DisplayName = ".Net" }
  [PSCustomObject]@{ FileName = "$PSScriptRoot\spotify.ps1"; DisplayName = "Spotify" }
)
